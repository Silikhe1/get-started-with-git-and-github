Getting Started With and GitHub
===================================

Explaining Git and GitHub. Forked from [Silikhe](https://github.com/Silikhe). The following commands below are to be run in the Terminal.App for Linux.
## Some links for more in depth learning

### Purely text based resources
* [Git: No Deep Sh*t](http://rogerdudler.github.io/git-guide/) A super simplified way of explaining git, basically at git cheatsheet.
...
### By typing this command I am saving a collection of saved files.
